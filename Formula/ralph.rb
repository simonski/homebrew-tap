class Ralph < Formula
  ...
  on_macos do
    on_arm do
      url "https://github.com/simonski/ralph/releases/download/v0.1.0/ralph_0.1.0_darwin_arm64.tar.gz"
      sha256 "2a97bfb606ba666cae395fe091bd202032eebf7e82294c9be6ae86edadcfde11"
    end

    on_intel do
      url "https://github.com/simonski/ralph/releases/download/v0.1.0/ralph_0.1.0_darwin_amd64.tar.gz"
  ...
  on_linux do
    on_arm do
      url "https://github.com/simonski/ralph/releases/download/v0.1.0/ralph_0.1.0_linux_arm64.tar.gz"
      sha256 "f25f18f31fce819f28364e3c67f14c446f4b788e9887450afdec588fff034466"
    end

    on_intel do
      url "https://github.com/simonski/ralph/releases/download/v0.1.0/ralph_0.1.0_linux_amd64.tar.gz"
